...
const NAV = [
  { to: '/entries',  label: 'Entries',    icon: FileIcon },
  { to: '/entities', label: 'Entities',   icon: UsersIcon },
  { to: '/timeline', label: 'Timeline',   icon: TimelineIcon },
  { to: '/graph',    label: 'Graph',      icon: GraphIcon },
  { to: '/map',      label: 'Map',        icon: MapIcon },
  { to: '/search',   label: 'Search',     icon: SearchIcon },
  { to: '/ai',       label: 'AI Queries', icon: AIIcon },
]
  ...
  return (
    <aside className="w-56 bg-surface-900 border-r border-surface-700 flex flex-col shrink-0">
      ...
      <div className="h-14 flex items-center px-5 border-b border-surface-700">
        <span className="text-amber-400 font-bold text-lg tracking-wide">NEXUS</span>
        <span className="ml-2 text-surface-600 text-xs font-mono">v1</span>
      </div>
      ...
      <div className="px-4 pb-4 pt-2 border-t border-surface-700">
        <p className="text-xs text-surface-600 leading-relaxed">
          Private research platform.<br />Keep it secure.
        </p>
      </div>
    </aside>
  )
...
// ─── Inline SVG icons (no icon library dep needed) ────────────────────────────
